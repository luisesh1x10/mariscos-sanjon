class CustomersController < ApplicationController
  ...
  def index
    ...
    @customers =@customers.where("lower(nombre) like '#{nom.downcase}%'") unless  params[:nombre].nil? or  params[:nombre]==""
  end
  ...
  private
    ...
    def customer_params
       params.require(:customer).permit(:nombre, :telefono, :calle, :colonia, :numero_interior, :numero_exterior,:anotaciones)
    end
    def order_params
