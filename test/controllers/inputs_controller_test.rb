...
class InputsControllerTest < ActionController::TestCase
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post :create, input: { cantidad: @input.cantidad, precio: @input.precio, resource_id: @input.resource_id }
    end
  ...
  test "should update input" do
    patch :update, id: @input, input: { cantidad: @input.cantidad, precio: @input.precio, resource_id: @input.resource_id }
    assert_redirected_to input_path(assigns(:input))
  end
